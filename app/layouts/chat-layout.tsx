        ...
        <ScrollArea className="h-[calc(100vh-120px)]">
          <div className="space-y-4 p-4">
            <div className="space-y-1">
              ...
              <div className="space-y-1">
                <NavLink to="/chat" className="w-full justify-start flex items-center gap-2">
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    isActive
                      ? 'w-full justify-start flex items-center gap-2 bg-primary/10 text-primary transition-colors duration-200 rounded-2xl'
